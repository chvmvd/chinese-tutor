        ...
        await Promise.all(
          (JSON.parse(modules) as Module[]).map(async (module) => {
            ...
            const speakers = JSON.parse(
              (await AsyncStorage.getItem(`module_${moduleId}_speakers`)) ??
                "[]",
            ) as Speaker[];
            ...
            const sentences = JSON.parse(
              (await AsyncStorage.getItem(`module_${moduleId}_sentences`)) ??
                "[]",
            ) as Sentence[];
            const vocabularies = JSON.parse(
              (await AsyncStorage.getItem(`module_${moduleId}_vocabularies`)) ??
                "[]",
            ) as Vocabulary[];
            const characters = JSON.parse(
              (await AsyncStorage.getItem(`module_${moduleId}_characters`)) ??
                "[]",
            ) as Character[];
            return {
              id: module.id,
